        ...
        public IActionResult GetJwks()
        {
                ...
                Keys = new List<JwksKey>
            {
                new JwksKey
                {
                    ...
                    Alg = "RS256",
                    N = Base64UrlEncode(OpenIdConfig._rsaParameters.Modulus), // "your-modulus-base64-url-encoded",
                    E = Base64UrlEncode(OpenIdConfig._rsaParameters.Exponent) //"your-exponent-base64-url-encoded"
                }
                }
            };
